...
FLOWER_MODEL_PATH = os.path.join(ROOT_DIR, "artifacts", "flower_classifier", "20251108-143250", "best_model.pth")
DISEASE_MODEL_PATH = os.path.join(ROOT_DIR, "artifacts", "disease_detector","20251108-150231_yolov8s", "weights", "best.pt")
